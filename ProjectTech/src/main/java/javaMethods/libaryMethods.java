...
public class libaryMethods {
	...
	public  void mouseHoverAction(WebDriver driver,WebElement mainElement, String subElement)
	{
		...
		if(subElement.equals("Mens Watches"))
		{
			action.moveToElement(driver.findElement(By.cssSelector("a[title='Watches'][href*='Men']")));
	...
	public void SendTextMethod(WebDriver driver,String strObject,String inputuser) throws Exception
	{
		...
		WebElement element=driver.findElement(By.cssSelector(strObject));
	...
	public void selectDropDown(WebDriver driver,WebElement strObject,String DropDownValue) throws Exception
	{
...
*/
		Select selectDropDownMenu=new Select(strObject);
	...
	public void  clickonElementWithActionMethod(WebDriver driver,String Object) throws InterruptedException
	{
		...
		WebElement mainMenu = driver.findElement(By.cssSelector(Object));
